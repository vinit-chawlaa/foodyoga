...
const Manufacture = () => {
    return (
        <div className='w-full min-h-screen px-10 md:px-20 pt-20'>
            ...
            <div className='py-10 flex gap-5 md:flex-row flex-col'>
                <div className='md:border-r-2 md:border-gray-400 max-w-[350px] px-5'>
                    <h1 className='text-3xl'>Production Capacity of <br />
                        <span className='font-bold'>2,000 tons per year.</span>
                    </h1>
                </div>

                <div className='max-w-[540px] px-5'>
                    <p className='font-semibold text-xl'>Renowned for its quality and innovation, Sattviko, the
