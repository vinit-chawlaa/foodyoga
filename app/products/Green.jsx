  ...
  return (
    <div>
      ...
      <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold absolute top-5 z-3 mt-5 sm:mt-0">
        <span className='font-bold'>Lotus Puffs</span> Sweet Chilli Flavour
       </h1>
        ...
        <div className='flex-1 relative -mt-30'>
          <Image src='/green.png' width={1000} height={1000} alt='' className='w-full min-h-200 object-cover' loading="lazy" />
