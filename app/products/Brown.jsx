...
const Brown = () => {
  return (
    <div>
        ...
        <span className='font-bold'>Lotus Puffs</span> Caramel Flavour
       </h1>
        ...
        <div className='flex-1 relative -mt-30'>
         <Image src='/brown.png' width={1000} height={1000} alt='' className='w-full min-h-200 object-cover' loading="lazy" />
