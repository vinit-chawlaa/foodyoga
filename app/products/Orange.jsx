...
const Orange = () => {
  return (
    <div>
        <div className='flex lg:flex-row justify-center items-center flex-col md:gap-10 w-full mt-5 px-5 '>
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold absolute top-5 mt-5 sm:mt-0">
        <span className='font-bold'>Multigrain Puffs</span> Peri Peri  Flavour
       </h1>

   
        
        <div className='flex-1 relative -mt-25'>
         <Image src='/orange.png' width={1000} height={1000} alt='' loading='lazy' className='w-full min-h-200 object-cover' />
